...
class ColorPsychologyAnalyzer:
    ...
    def calculate_comprehensive_score(self, image_path):
        ...
        return {
            ...
            'recommendations': self.generate_recommendations(
                harmony_score, temperature_score, saturation_score, 
                brightness_score
            )
        }
    ...
    def visualize_analysis(self, image_path, save_path=None):
        ...
        for i, recommendation in enumerate(result['recommendations']):
            ax4.text(0.1, 0.8 - i*0.1, f'• {recommendation}', fontsize=11, 
...
def main():
    ...
    # 分析单张图像
    image_path = "D://AIGC/Colorsbeauty/picture/2.jpg"  # 替换为你的图像路径
